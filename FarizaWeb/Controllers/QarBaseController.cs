...
public class QarBaseController : Controller
{
    ...
    public readonly string[] ImageFileExtensions = { ".jpg", ".png", ".gif", ".jpeg", ".webp", ".avif", ".svg" };
       protected readonly string[] VideoFileExtensions = { "mp4", "mov" };
        ...
        string multiLanguageJson)
    {
        ...
        catch (Exception ex)
        {
            ...
            return MessageHelper.RedirectAjax(T("ls_Edjd"), Status.Error, "", "multiLanguageJson");
        }
        ...
        using (var connection = Utilities.GetOpenConnection())
        {
            ...
            if (additionalContent == null)
                return MessageHelper.RedirectAjax(T("ls_Idoiiw"), Status.Error, "", null);
